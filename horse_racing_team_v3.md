...
- 데이터: 1,491일치 / 고유 말 10,560마리 (2021-04-10 ~ 2026-05-17)
- **Phase 3 예정**: v3.0 재학습 (데이터 추가 + Bayesian 피처 적용)
...
### 당장 해야 할 것 (우선순위 순)
1. **v3.0 재학습**: `POST /ml/train?start_date=2021-04-10&version=v3.0` (XGBoost + LightGBM 각각)
