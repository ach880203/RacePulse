package com.racepulse.backend.domain.jockey.entity;
...
public class Jockey {
    ...
    // V8 마이그레이션에서 jockey_code → license_no 로 컬럼명 변경됨
    ...
    @Column(name = "place_rate_total", precision = 5, scale = 4)
    private BigDecimal placeRateTotal;
